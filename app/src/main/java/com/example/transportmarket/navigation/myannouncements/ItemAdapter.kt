...
class ItemAdapter(
        private val context: MyAnnouncementsFragment,
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.textViewmocSilnika.text = "Moc silnika: ${item.mocSilnika}"
        holder.textViewpojemnoscSilnika.text = "Pojemnośc silnika: ${item.pojemnoscSilnika}"
